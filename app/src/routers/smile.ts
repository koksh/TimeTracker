...
import type { SmileState } from '../types.js';

const smileState: SmileState = {
  startDate: new Date().toISOString(),
  finishDate: null,
  message: null,
};

const smileRoutes: FastifyPluginAsync = async (app) => {
  app.get('/',
  {
    schema: {
  ...
  app.post<{
    Body: { startDate?: string; finishDate?: string | null; message?: string };
  }>('/',
  {
    schema: {
